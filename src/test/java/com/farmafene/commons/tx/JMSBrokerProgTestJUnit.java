...
import com.farmafene.commons.tx.amq.VMBrokerProg;
...
public class JMSBrokerProgTestJUnit {
	private static final Logger LOGGER = LoggerFactory.getLogger(JMSBrokerProgTestJUnit.class);
	...
	public void test01() {
		...
		sb = new StringBuilder();
		sb.append(lf).append("/+--------------------------------------------------+");
		sb.append(lf).append(" | LIBERANDO BEANS                                  |");
		sb.append(lf).append(" +--------------------------------------------------+");
		LOGGER.info("{}", sb);
	}
}
